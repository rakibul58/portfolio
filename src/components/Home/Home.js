...
const Home = () => {
    return (
        ...
        <div className='flex flex-wrap items-center lg:justify-around gap-5 w-full my-20 pr-10 lg:pr-0 animate animatecss animatecss-backInDown'>
            <div>
            ...
            <div>
                <img className='animate animate-pulse hover:animate-spin w-full lg:w-2/3 p-5 border rounded-full bg-gradient-to-tr from-primary to-secondary' src="https://i.ibb.co/b64SJxZ/1659429560757-removebg-preview.png" alt="" />
            </div>
        </div>
